...
class EmailTemplateSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('email_templates')->insert([
            'id'             				=> '12',
			'slug'        					=> 'user-account-created-rfp',
			'email_template_title'         	=> "$"."request->first_name Thanks To Sign Up At  Lang::get('general.site_name')",
            'email_template_content'     	=> "<p>Congratulations $"."request->first_name Your Account Has Been
             									Created Successfully At  Lang::get('general.site_name') </p>
												<p>Username: $"."request->username</p>
												<p>Username: $"."request->password</p>
												<p>Note: Temporary password set to this account, please login through below url and change password</p>
												<p>Click <a href=$"."login_url>here</a> to login or copy and paste below url to browser</p>
												<p> $"."login_url </p> 
												<p>Thanks</p> 
												<p>Lang::get('general.site_name')</p>",
            'email_template_order'      	=> '12',
        ]);
