                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <form action="{{ route('admin_post_add_post') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="row form-group">
                                    <div class="col-sm-12">
                                        <div class="field">
                                            ...
                                            <input type="text" value="{{ old('title') }}" name="title" placeholder="Page title here... (Eg: Home Page)" class="form-control form-control-lg">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row custom_url form-group" >
                                    <div class="col-sm-12">
                                        <div class="field">
                                            ...
                                            <input type="text" value="{{ old('short_title') }}" name="short_title" placeholder="Page short title here... (Eg: Home)" class="form-control form-control-lg" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row pages form-group" >
                                    <div class="col-sm-12">
                                        <div class="field">
                                            ...
                                            <textarea name="content" class="form-control form-control-lg my-editor">{{ old('content') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                             ...
                             <!--    <div class="row">
                                    <div class="col-sm-12">
                                        <div class="field">
                                            ...
                                            <input type="text" value="{{ old('page_video') }}" name="page_video" placeholder="https://www.youtube.com/embed/3h-1h168Blo" class="form-control form-control-lg" />
                                        </div>
                                    </div>
                                </div> -->
                                  ...
                                  <div class="col-sm-12 form-group">
                                        ...
                                        <div class="field">
                                            <div class="col-sm-10 form-group float-left p-0">
                                                <input type="text" id="thumbnail_sec4_left" name="page_video" value="{{ old('page_video')   }}" class="form-control form-control-lg" />
                                            </div>
                                ...
                                <div class="row">
                                            ...
                                            <div class="upload-bx">
                                                <div class="field file_manager_field">
                                                    ...
                                                    <input type="text" id="thumbnail" name="page_image" value="{{ old('page_image')  }}" class="form-control form-control-lg" />
                                                ...
                                                <select name="template" class="form-control form-control-lg">
                                                    ...
                                                    @if(!empty(getTemplates()))
                                                        @foreach(getTemplates() as $name => $template)
                                                            <option value="{{ $name }}" @if( old('template') == $name ) selected="" @endif>{{ $template }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="field">
                                                ...
                                                <input type="text" name="meta_title" value="{{ old('meta_title') }}" class="form-control form-control-lg">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="field">
                                                ...
                                                <input type="text" name="meta_keywords" value="{{ old('meta_keywords') }}" class="form-control form-control-lg">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="field">
                                                ...
                                                <input type="text" name="meta_description" value="{{ old('meta_description') }}" class="form-control form-control-lg">
                                            </div>
                                        </div>
                                    </div>
