                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <form action="{{ route('admin_post_update_post',['id'=>$page->id]) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                           ...
                           <div class="col-sm-12 form-group">
                                        ...
                                        <div class="field">
                                            <div class="col-sm-10 form-group float-left p-0">
                                                <input type="text" id="thumbnail_sec4_left" name="page_video" value="{{ old('page_video',$pageDescription->page_video ?? '')   }}" class="form-control form-control-lg" />
                                            </div>
