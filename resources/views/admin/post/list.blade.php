                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="styled-head">
                            <h2>@lang('admin/post.list_title')</h2>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered listall">
                                        <thead>
                                            <tr>
                                                <th>@lang('admin/post.id')</th>
                                                <th>@lang('admin/post.title')</th>
                                                <th>@lang('admin/post.short_title')</th>
                                                <th>@lang('admin/post.slug')</th>
                                                <th>@lang('admin/post.status')</th>
                                                <!-- <th>@lang('admin.post.created_at')</th> -->
