					...
					<div class="form ptpx-20 pbpx-100">
						<div class="row">
							<div class="col-sm-5 addCheckbox">
								...
								<div class="clearfix  mbpx-15">
									<label><input type="checkbox" name=""> Would you like to have this product Halal Certified?</label>
								</div>
								<div class="clearfix  mbpx-15">
									<label><input type="checkbox" name=""> You have already halal certificate - <a href="javascript:;">Upload</a></label>
								</div>
								<div class="clearfix  mbpx-20">
									<a href="javascript:;" class="primary-btn green-bg">Add Products</a>
								</div>
							</div>
							<div class="col-sm-7">
