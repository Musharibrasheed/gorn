<aside class="content-box side-bar">
	<div class="chat-sidebar">
		...
		<div class="status">
			<ul>
				<li>
					<a href="javascript:;" class="active">Online</a>
				</li>
				<li>
					<a href="javascript:;">Offline</a>
				</li>
			</ul>
			<span>
				<a href="javascript:;">
		...
		<div class="users-lst">
			<div id="scr-content">
				<ul>
					...
					<li>
						<figure>
							{{ HTML::image('images/abbas.png', 'Safina Bay') }}
							<i class="availablity"></i>
						</figure>
						<p>Al Abbas</p>
						<div class="points">
		...
		<div class="view-all text-center">
			<a href="javascript:;" class="primary-btn grey">See all Contact</a>
		</div>
	</div>
</aside>