...
class PostRepository  extends AbstractRepository
{
    ...
    protected $description_table    = 'posts_description';
    ...
    public function __construct(
        ...
        $this->model                = $page;
        $this->description_model    = $PostDescription;
    }
     ...
     public function all()
    {
        ...
        return $this->model::join(
            ...
            ->select(['posts.*', 'posts_description.*'])->get();
    }  

    public function getDescriptionById($id,$language_id=1)
    {

        $page_description = PostDescription::where('page_id',$id)
    ...
    public function getPagesList()
    {
        ...
        return $this->model::join(
            ...
            ->where($this->description_table.'.language_id',$language_id)
            ->select(['posts.id', 'posts_description.title', 'posts_description.short_title', 'posts.slug', 'posts.status', 'posts.created_at'])->get();
    }
    ...
    public function getFrontPageBySlug($slug)
    {
        ...
        return $this->model::join(
            ...
            ->select(['posts.*', 'posts_description.*'])
            ->first();
    }
